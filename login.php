  ...
  <div class="container">
    <div class="navi">
      <div class="head-logo">
        ...
        <p>&nbsp;</p>
        <h3>&nbsp;</h3>
        <a href="online.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','images/7DD4.png',1)"><img src="images/7DD4.tm.png" alt="" width="47" height="55" id="Image6"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','images/7D7B.png',1)"><img src="images/7D7B.tm.png" alt="" width="46" height="56" id="Image7"></a><a href="#online" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','images/7D1D.png',1)"><img src="images/7D1D.tm.png" alt="" width="143" height="56" id="Image8"></a>
        <p>&nbsp;</p>
...
<!-- blog -->
	...
	<div class="container">
	  ...
	  <div id="online" class="online">
	    <div class="comments">
			<p>&nbsp;</p>
			<a name=“online”><h1>后台登录</h1> 
            </a>
			<form action = <?php echo "'".LIB_PATH."/Admin/index/login/' "?> method="POST" onsubmit="return check(this)">
				<p>
