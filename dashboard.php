	...
	<div class="container">
	  ...
	  <div class="blog-right">
		  ...
		  <div class="categories">
		    <ul>
		    <?php
		    	if( !$client -> get(LIB_PATH."/Admin/Index/getNotification/username/".$USER)){
						echo "网络错误";
					}else{
		    ...
		    ?>
		      <li><a href='admin/read.php?id=<?php echo $item["id"]?>'><?php echo $item["author"].":&nbsp;".$item["content"]?></a><br/>
		      <?php echo $item["date"]?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span onclick='read(<?php echo $item["id"]?>, <?php echo "\""."$USER"."\""?>)'>标为已读<span></li>
		      <?php }}?>
	        </ul>
		    <p>&nbsp;</p>
		    <p>&nbsp;</p>
