...
<!-- blog -->
	...
	<div class="container">
	  ...
	  <div class="blog-right">
		  <h2><?php if($query != "") echo "文章标题链接LINKS" ?></h2>
		  <div class="categories">
		    <ul>
		    	<?php 
		    	if($query != "" && $client -> get(LIB_PATH."/Home/index/search/key/".$query)){
		    	...
		    	?>
		      <li><a href='single.php?p=<?php echo $item["id"]?>'><?php echo $item["title"]?></a><br/><span><?php echo $item["date"]?></span></li>
		      <?php }}?>
	        </ul>
		    <p>&nbsp;</p>
		    <p>&nbsp;</p>
